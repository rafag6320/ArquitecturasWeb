...
public class Main {
    public static void main(String[] args) {
        ...
        Estudiante estudiante = new Estudiante(812517, 8593, 32, "Marcelo", "Stoichov", "Masculino", "Pergamino");
        estudianteRepository.save(estudiante);

        // Ej 2 - (b) Matricular estudiante en una carrera
        matriculaRepository.save(estudiante.getDNI(), 1, 2023, 0, 2);

        // Ej 2 - (c) Recuperar los estudiantes
